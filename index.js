...
//!word "input word"
	if(cmd === `${prefix}word`){ 										
		word = messageArray[1];
		message.delete(100);											//deletes the message which includes the entered word
...
//!guess
		...
		console.log("\x1b[34m", "\x1b[47m", "Player's guess is: " + guessedWord);
		console.log("\x1b[0m");
		guessWord();
	}
	...
	function tryletter() {
		...
		for(i = 0; i<charLength; i++) {    
			if(letter === lWord[i]) {
			  txt[i] = letter;
			  misscount = 0;
			  console.log("\x1b[42m", "Letter accepted");
			  console.log("\x1b[0m");
			}  
			else {
			  misscount++;
			...
			if(misscount === charLength) {
			  misscount = 0;
			  misses++;
			  console.log("\x1b[41m", "Letter declined");
			  console.log("\x1b[0m");
			  lostCheck();
...
//CHOOSES A RANDOM WORD FROM THE WORDS ARRAY (WORKING)
	function generateWord() {
		wordsLength = words.length;
		generateNumber = Math.random() * wordsLength;
		flooredNumber = Math.floor(generateNumber);
		randomWord = words[flooredNumber];
		console.log("\x1b[45m", "The bot has picked the word: " + randomWord);
		console.log("\x1b[0m");
		word = randomWord;
		startGame();
		}
...
//GUESS A WORD (WORKING)
	function guessWord(){
		if(guessedWord === word){
			console.log("\x1b[32m", "\x1b[47m", "Guess accepted");
			console.log("\x1b[0m");
			message.channel.send("You have won, the word was " + word + "!");
			console.log("\x1b[32m", "Player has guessed the word");
			console.log("\x1b[0m");
			...
			console.log("\x1b[31m", "\x1b[47m", "Guess declined");
			console.log("\x1b[0m");
			misses++;
